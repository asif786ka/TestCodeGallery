...
public class HighlightView
{
	...
	public void draw(Canvas canvas)
	{
		...
		else
		{
			...
			// Was: 0xFFFF8A00
			mOutlinePaint.setColor(mContext.getResources().getColor(R.color.highlight));

			// canvas.clipPath(path, Region.Op.DIFFERENCE);
			// This causes the image to dim a bit, which I don't like:
			...
			if (mMode == ModifyMode.Grow)
			{
				...
				mResizeDrawableHeight.setBounds(xMiddle - heightWidth, bottom - heightHeight, xMiddle + heightWidth,
						bottom + heightHeight);
				mResizeDrawableHeight.draw(canvas);
			}
		}
